...
let SensorButtonCardEditor = class SensorButtonCardEditor extends LitElement {
    setConfig(config) {
        this._config = config;
    }
    get _name() {
...
__decorate([
    property()
], SensorButtonCardEditor.prototype, "hass", void 0);
__decorate([
    property()
], SensorButtonCardEditor.prototype, "_config", void 0);
__decorate([
    property()
], SensorButtonCardEditor.prototype, "_toggle", void 0);
SensorButtonCardEditor = __decorate([
    customElement('sensor-button-card-editor')
], SensorButtonCardEditor);
...
/* eslint no-console: 0 */
console.info(`%c  SENSOR-BUTTON-CARD \n%c  ${localize('common.version')} ${CARD_VERSION}    `, 'color: orange; font-weight: bold; background: black', 'color: white; font-weight: bold; background: dimgray');
// TODO Name your custom element
let SensorButtonCard = class SensorButtonCard extends LitElement {
    static async getConfigElement() {
        return document.createElement('sensor-button-card-editor');
    }
    ...
    setConfig(config) {
        ...
        this._config = Object.assign({ name: 'Sensor Button' }, config);
    }
...
__decorate([
    property()
], SensorButtonCard.prototype, "hass", void 0);
__decorate([
    property()
], SensorButtonCard.prototype, "_config", void 0);
SensorButtonCard = __decorate([
    customElement('sensor-button-card')
], SensorButtonCard);

export { SensorButtonCard };
